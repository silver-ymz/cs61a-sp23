        ...
        if self.stock == 0:
            ...
            if self.balance < self.price:
                ...
                if balance == self.price:
                    ...
                    return (
                        f"Here is your {self.name} and ${balance - self.price} change."
                    )
...
class Player:
    ...
    def debate(self, other: Self):
        ...
        if random() <= probability:
            ...
            self.popularity -= min(50, self.popularity)

    def speech(self, other: Self):
        p1 = self.popularity // 10
        self.votes += p1
        self.popularity += p1
        p2 = other.popularity // 10
        other.popularity -= min(p2, other.popularity)
